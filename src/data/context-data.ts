...
const context_data: contextType[] = [
  ...
  //home two context data
  {
    ...
    description: "I would like to focus on cloud providers: Major players like AWS, Microsoft Azure, and Google Cloud Platform compete directly with Canonical's Ubuntu cloud offerings. They often provide managed services and proprietary solutions that can lock in customers. The growing importance of open-source skills and the rising popularity of cloud adoption may benefit Canonical. Focusing on specific strengths like security, large-scale deployments, and community support can position them effectively. Navigating the balance between open-source principles and generating sustainable revenue remains a key challenge.",
    boxWrapperClass: "pl-55",
    animated: "canonical-assessment-vertical-animated-line-4",
  },
  {
